        ...
        <section class="listings_one_wrap listings_one_wrap--listings-three">
            <div class="container clearfix">
                <div class="listings__one__content">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="input_box">
                                        <div class="select-box">
                                            <select id="categories_id" name="category" data-placeholder="--- Chọn danh mục ---" class="form-control form-control-select2" data-fouc >
                                        ...
                                        <div class="select-box">
                                            <select class="selectmenu wide">
                                                <option selected="selected">
                                                    All Price Type</option>
                                                <option>Default Sorting 1
                                                </option>
                                                <option>Default Sorting 2
                                                </option>
                                                <option>Default Sorting 3
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="filter">
                            <div class="filter_inner_content">
                                <div class="left">
                                    <div class="left_text">
                                        @if($projects->count())
                                            <h4>Tìm thấy {{ $projects->count()}} kết quả</h4>
                                        @else
                    ...
                    <section class="listings_three-page one row data-table">
                    @if(isset($projects))
                    @foreach($projects as $project)
                    @php
                        $reviews = \App\Models\Review::where('event_id', $project->id)->where('type', 'project')->get();
                    @endphp
                        <div class="col-lg-4 col-sm-6 jeg_pl_md_1 d-flex">
                            <!--Start Place One Single-->
                            <div class="place-one__single w-100">
                                ...
                                <div class="place-one__single-content">
                                    <div class="top-content">
                                        <h2> <a href="{{ $project->showUrl() }}">{{ $project->name }}</a></h2>
                                        <p>{{ $project->excerpt}}</p>
                                    ...
                                    {{--  <div class="bottom-content">
                                        ...
                                        <div class="count-box">
                                            <p>({{number_format($reviews->avg('rating'), 1)}})</p>
                                        </div>
                                    </div>  --}}
                                </div>
                            </div>
