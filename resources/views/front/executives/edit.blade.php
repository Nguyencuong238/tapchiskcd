            ...
            <div class="col-xl-9 col-lg-8">
                <div class="profile-info-block">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('executives.update') }}" method="post" id="excutive_update">
                                @csrf
                                <input type="hidden" name="id" value="{{$executive->id}}">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>{{ __('Tên') }}:</label>
                                        <input type="text" name="name" value="{{ old('name', $executive->name) }}" class="form-control @error('name')is-invalid @enderror" required>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="position" class="form-control @error('position')is-invalid @enderror" required 
...
@section('custom-js')
    ...
    <script>
        $('#excutive_update').on('submit', function() {
