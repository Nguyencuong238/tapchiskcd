                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control form-control-select2" name="position">
                                ...
                                <option value="manager" @if(old('position', $user->position) == 'manager') selected @endif>Trưởng phòng</option>
                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="email" value="{{ old('email', $user->email) }}" class="form-control @error('email')is-invalid @enderror" required>
                            @error('email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
