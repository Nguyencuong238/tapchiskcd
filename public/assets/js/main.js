! function(e) {
    ...
    e(window).on("scroll", (function() {
        var t, a, n, i, o;
        t = e(".sticky-active"), a = "active", n = "will-sticky", i = e(window).scrollTop(), o = t.css("height"), t.parent().css("min-height", o), e(window).scrollTop() > 400 ? (t.parent().addClass(n), i > s ? t.removeClass(a) : t.addClass(a)) : (t.parent().css("min-height", "").removeClass(n), t.removeClass(a)), s = i, e(this).scrollTop() > 500 ? e(".scrollToTop").addClass("show") : e(".scrollToTop").removeClass("show")
        ...
        if (e(".filter-active").length > 0) {
            ...
            })), e(".filter-menu-active").on("click", "button", (function(s) {
    ...
    i.on("init", (function(s, t, a) {
                ...
                if (a.on("click", (function(s) {
                    ...
                    a.each((function() {
                        ...
                        a.attr("data-slide-go-to", o), o++, a.hasClass("active") && e(i).slick("slickGoTo", a.data("slide-go-to")), e(i).on("beforeChange", (function(e, a, n, i) {
                            s.find(t.tabButton + '[data-slide-go-to="' + i + '"]').addClass("active").siblings().removeClass("active"), l()
                        }))
                    }))
                }
            ...
            sliderTab: !0,
            tabButton: ".tab-btn"
        }), e(".recent-post-tab").length && e(".recent-post-tab").vsTab({
            sliderTab: !0,
            tabButton: ".nav-link"
        }), SmoothScroll({
            animationTime: 1e3,
            ...
            e(document).on("mousemove", e => {
                t.targetX = e.pageX, t.targetY = e.pageY
            });
            let a = function() {
                t.x += .2 * (t.targetX - t.x), t.y += .2 * (t.targetY - t.y), s.css({
                    transform: "translate(" + Math.floor(t.x - 5) + "px, " + Math.floor(t.y - 5) + "px)"
                }), requestAnimationFrame(a)
            };
            a()
        }, e(".vs-cursor").vsCursor(), t = ".sidemenu-wrapper", a = ".sideMenuCls", n = "show", e(".sideMenuToggler").on("click", (function(s) {
        ...
        function(s, t, a, n) {
        ...
        }(".popup-search-box", ".searchBoxTggler", ".searchClose", "show"), (new universalParallax).init(), e(".parallax").length && e(".parallax").each((function() {
        ...
        })), e(".vs-carousel").on("afterChange", (function(s, t, a, n) {
            e(t.$slides).find("[data-ani]").removeClass("vs-animated"), e(t.$slides[a]).find("[data-ani]").addClass("vs-animated")
            ...
            var s = e(this).data("bs-target");
            e(s).find(".vs-carousel").slick("refresh")
        }))
}(jQuery);