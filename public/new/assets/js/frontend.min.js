                    ...
                    (window.jnews.loginregister = {
                        ...
                        validateForm: function (e) {
                            var i = t(e).find(".form-message"),
                                n = t(e).data("type");
                            if ("register" === n) {
                                if ("" === t(e).find('[name="email"]').val()) return i.html("<p class='alert alert-error print-hide'>" + jnewsoption.lang.empty_email + "</p>"), !1;
                            }
                            if ("login" === n || "register" === n) {
                                if ("" === t(e).find('[name="username"]').val()) return i.html("<p class='alert alert-error print-hide'>" + jnewsoption.lang.empty_username + "</p>"), !1;
                            }
                            if ("login" === n) {
                                if ("" === t(e).find('[name="password"]').val()) return i.html("<p class='alert alert-error print-hide'>" + jnewsoption.lang.empty_password + "</p>"), !1;
                            }
                            if ("forgot" === n) {
                                if ("" === t(e).find('[name="user_login"]').val()) return i.html("<p class='alert alert-error print-hide'>" + jnewsoption.lang.empty_username + "</p>"), !1;
                            }
                            return !(1 == jnewsoption.recaptcha && !this.validateCaptcha) || (i.html("<p class='alert alert-error print-hide'>" + jnewsoption.lang.invalid_recaptcha + "</p>"), !1);
                        },
                        hook_form: function () {
                            var e = this;
                                        ...
                                        (e.xhr = t.post(jnews_ajax_url, { action: "jnews_refresh_nonce", refresh_action_nonce: "jnews_nonce" }).always(function (o) {
                                            ...
                                            (t(i).find('input[name="jnews_nonce"]').val(o.jnews_nonce),
                                                (e.xhr = t.ajax({
                                                    ...
                                                    data: t(i).serialize(),
                                                    success: function (e) {
                                                        1 == e.response && (n.html("<p class='alert alert-success print-hide'>" + e.string + "</p>"), 1 == e.refresh && (window.location = jnewsoption.login_reload)),
                                                        0 == e.response && n.html("<p class='alert alert-error print-hide'>" + e.string + "</p>"),
